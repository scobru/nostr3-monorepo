      ...
      <div className="px-4 py-5 sm:px-6 text-lg hover:dark:bg-base-300/25 hover:!text-xl hover:underline hover:decoration-green-300">
        <div className="flex flex-row justify-center">
          <span className="text-lg font-semibold">
            Current <span className=" dark:text-green-300">Relay</span>:{" "}
          </span>
          <span className="ml-5 inline-flex items-center gap-x-1.5 rounded-md px-1.5 py-0.5 text-xs font-medium">
        ...
        <div className="mt-2">
          <div className="flex flex-row w-full space-x-5">
            <div className="flex flex-col w-1/2">
              <label
                id="listbox-label"
                className="block text-lg font-semibold leading-6 text-gray-800 dark:text-gray-200"
              >
                Popular <span className=" dark:text-green-300">Relays</span>:
              </label>
                    ...
                    <RadioGroup.Option
                      ...
                      className={() =>
                        classNames(
                          ...
                          "relative block cursor-pointer rounded-lg border bg-white/50 px-6 py-4 shadow-sm focus:outline-none sm:flex sm:justify-between hover:bg-base-300/75",
                        )
                      }
                    >
                      {({ active, checked }) => (
                        <>
                            ...
                            <span className="flex flex-col text-sm w-full">
                              <RadioGroup.Label
                                ...
                                className={classNames(
                                  relay == selectedRelay ? "text-gray-900 dark:text-white font-bold" : "text-gray-900",
                          ...
                          <span
                            className={classNames(
                              ...
                              checked ? "border-dashed border-green-300 bg-base-300/25" : "border-transparent",
            ...
            <div className="flex flex-col w-1/2">
              <label
                ...
                className="block text-lg font-semibold leading-6 text-gray-800 dark:text-gray-200"
              >
                Custom <span className="">Relay</span>:
              </label>
              <div className="mt-2 flex rounded-md shadow-sm">
                <span className="inline-flex items-center rounded-l-md bg-white/50 border border-r-0 border-gray-300 px-3 py-4 text-gray-800 dark:text-gray-200 sm:text-sm">
                  wss://
                </span>
                <input
                  ref={customRelayUrl}
